        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-6 text-white">
                    <h3 class="font-semibold text-lg mb-2">Need Quick Answers?</h3>
                    <p class="text-gray-300 text-sm mb-4">Check out our frequently asked questions.</p>
                    <a href="{{ route('pages.index') }}" class="inline-flex items-center gap-2 text-sm font-medium hover:underline">
                        View FAQ
