<x-layouts.default-layout title="Edit {{ $address->type === 'shipping' ? 'Shipping' : 'Billing' }} Address">

    <div class="py-8">

        {{-- Page Header --}}
        <x-ui.page-header
            title="Edit {{ $address->type === 'shipping' ? 'Shipping' : 'Billing' }} Address"
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="ico" id="ico" value="{{ old('ico', $address->ico) }}"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                </div>

                                <div>
                                    <label for="dic" class="block text-sm font-medium text-gray-700 mb-2">Tax ID</label>
                                    <input type="text" name="dic" id="dic" value="{{ old('dic', $address->dic) }}"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                </div>

                                <div class="md:col-span-2">
                                    <label for="ic_dph" class="block text-sm font-medium text-gray-700 mb-2">VAT ID</label>
                                    <input type="text" name="ic_dph" id="ic_dph" value="{{ old('ic_dph', $address->ic_dph) }}"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                </div>
                            </div>
                        </div>
